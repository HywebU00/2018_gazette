    ...
    Slick = (function() {
        ...
        function Slick(element, settings) {
            ...
            _.defaults = { //可以視情況加入
                ...
                prevArrow: '<button type="button" data-role="none" class="slick-prev" title="Previous" aria-label="previous">Previous</button>', //Allows you to select a node or customize the HTML for the "Previous" arrow.
                nextArrow: '<button type="button" data-role="none" class="slick-next" title="Next" aria-label="next">Next</button>', //Allows you to select a node or customize the HTML for the "Next" arrow.
                autoplay: false, //自動播放
